...
RSpec.describe 'Employees', type: :request do
  ...
  describe '#destroy' do
    context 'when employee exists' do
      before do
        ...
        delete "/employees/#{employee.id}", headers:
      end
    ...
    context 'when employee doesnt exists' do
      before { delete '/employees/100', headers: }
  ...
  describe '#update' do
    ...
    context 'with valid attributes' do
      before do
        put "/employees/#{employee.id}", params: { id: employee.id, employee: valid_attributes }, headers:
      end
    ...
    context 'with invalid attributes' do
      before do
        put "/employees/#{employee.id}", params: { id: employee.id, employee: invalid_attributes }, headers:
      end
